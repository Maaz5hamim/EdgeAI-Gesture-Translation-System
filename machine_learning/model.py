...
class DeepConvLSTM:
    ...
    def __init__(self, window_size=128, n_features=6, n_classes=4,
                 conv_filters=32, conv_kernel=3, lstm_units=40,
                 dropout_rate=0.5):
        """
        Args:
    ...
    def build_model(self):
        ...
        # Convolutional layers (4 layers as per paper)
        for i in range(2):
        ...
        model.add(layers.GlobalAveragePooling1D(name='avg_pool'))
    ...
    def train(self, X_train, y_train, X_val, y_val, 
        ...
        callback_list = [
            ...
            callbacks.ModelCheckpoint(
                filepath='best_deepconvlstm_model.h5',
    ...
    def evaluate(self, X_test, y_test, y_test_labels=None):
        ...
        gesture_names = ['SLIDE_UP', 'SLIDE_DOWN', 'SLIDE_LEFT', 'SLIDE_RIGHT']
        print("\n" + "-" * 70)
